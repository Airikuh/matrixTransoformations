...
#1st: Transformation with only x and y rotation
    #overall_transformation =   rot_x @ rot_y


#2nd: Transformation with scaling added

    #overall_transformation =  scaling_matrix @ rot_x @ rot_y

#3rd: Tranformation with translation added to scaling and x & y rotation
    #overall_transformation =  translation_matrix @scaling_matrix @ rot_x @ rot_y
